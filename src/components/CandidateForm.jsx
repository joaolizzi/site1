...
export default function CandidateForm() {
  ...
  // Função para mostrar termos LGPD em alert
  const showLGPDAlert = () => {
    const lgpdText = `
LEI GERAL DE PROTEÇÃO DE DADOS (LGPD)

O que é a LGPD?
A Lei Geral de Proteção de Dados (Lei nº 13.709/2018) é a legislação brasileira que regula o tratamento de dados pessoais por pessoas físicas e jurídicas, tanto no meio físico quanto no digital, com o objetivo de proteger os direitos fundamentais de liberdade e privacidade.

Seus Direitos:
• Confirmação e acesso: Saber se tratamos seus dados e acessá-los
• Correção: Corrigir dados incompletos, inexatos ou desatualizados
• Anonimização, bloqueio ou eliminação: Solicitar a anonimização, bloqueio ou eliminação de dados desnecessários
...
• Informação: Obter informações sobre as entidades com as quais compartilhamos dados
...
• Processamento de candidaturas e seleção de candidatos
• Verificação de documentos e informações fornecidas
• Comunicação sobre o processo seletivo
• Cumprimento de obrigações legais

Compartilhamento de Dados:
Seus dados pessoais não serão compartilhados com terceiros, exceto quando necessário para cumprimento de obrigação legal ou regulatória, ou mediante sua autorização expressa.
...
Contato:
Para exercer seus direitos ou esclarecer dúvidas sobre o tratamento de seus dados, entre em contato conosco através dos canais oficiais.
          ...
          <div className="form-group lgpd-group">
            <div className="checkbox-container">
              ...
              <label htmlFor="aceiteLGPD" className="checkbox-label">
                Li e aceito os termos da <button type="button" onClick={showLGPDAlert} className="lgpd-link">Lei Geral de Proteção de Dados (LGPD)</button> *
              </label>
            </div>
            ...
            <div id="lgpd-help" className="lgpd-help">
              <small>
                ...
                <button type="button" onClick={showLGPDAlert} className="lgpd-link"> Política de Privacidade</button>.
              </small>
            </div>
          </div>
